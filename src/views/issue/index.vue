  ...
  <div class="app-container">
    ...
    >
      ...
      <el-table-column prop="priority" label="优先级" align="center" >
        <template #default="{ row }">
           <span :style="{ color: getPriorityColor(row.priority) }">{{ getRowPriority(row.priority) }}</span>
        </template>
      </el-table-column>
...
<el-dialog
      :visible.sync="isssueDialogVisible"
      title="需求详情"
      width="50%"
    >
    
      <span slot="footer" class="dialog-footer">
        <el-button @click="isssueDialogVisible = false">关闭</el-button>
      </span>
    </el-dialog>
...
export default {
  ...
  methods: {
    ...
    // 搜索方法
    searchIssue() {
      this.getIssueFun(this.pageNum, this.pageSize,this.IssueForm.itemId,this.IssueForm.type,null);
    },
    // 每页多少
