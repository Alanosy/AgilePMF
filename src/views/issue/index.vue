<template>
    <div class="app-container">
      ...
      >
        ...
        <el-table-column prop="gradeName" label="问题类型" align="center" />
        <el-table-column prop="gradeCount" label="问题标题" align="center" />
        <el-table-column prop="code" label="优先级" align="center" />
        <el-table-column prop="userName" label="状态" align="center" />
        <el-table-column prop="userName" label="负责人" align="center" />
        <el-table-column prop="userName" label="创建时间" align="center" />
